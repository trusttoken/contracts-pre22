...
module.exports = async function(deployer) {
  ...
  const noFeesList = await AddressList.new("blackList", false)
  console.log("noFeesList Address: ", noFeesList.address)
  const trueUSD = await TrueUSD.new(mintWhiteList.address, canBurnWhiteList.address, blackList.address, noFeesList.address)
