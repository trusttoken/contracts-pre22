...
module.exports = async function(deployer) {
  ...
  const mintWhiteList = await NamableAddressList.new("mintWhiteList", false)
  console.log("mintWhiteList Address: ", mintWhiteList.address)
  const canBurnWhiteList = await NamableAddressList.new("canBurnWhiteList", false)
  ...
  const noFeesList = await NamableAddressList.new("noFeesList", false)
