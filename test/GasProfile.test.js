...
contract('GasProfile', function (accounts) {
  describe('--Gas Profiling--', function () {
    ...
    const [, owner, oneHundred, anotherAccount] = accounts.filter(hasNoZero)
    ...
    describe('without refund', function () {
      ...
      it('transferFrom', async function () {
        ...
        await this.token.approve(anotherAccount, DOLLAR, { from: oneHundred, gasPrice: 1 })
        ...
        await this.token.approve(oneHundred, BN(20).mul(DOLLAR), { from: anotherAccount, gasPrice: 1 })
        ...
        await this.token.approve(anotherAccount, BN(100).mul(DOLLAR), { from: oneHundred, gasPrice: 1 })
        ...
        await this.token.approve(oneHundred, BN(101).mul(DOLLAR), { from: anotherAccount, gasPrice: 1 })
        ...
        await this.token.approve(oneHundred, INFINITE, { from: anotherAccount })
        await this.token.approve(anotherAccount, INFINITE, { from: oneHundred })
    ...
    describe('with refund', function () {
      ...
      it('transferFrom', async function () {
        ...
        await this.token.approve(anotherAccount, DOLLAR, { from: oneHundred, gasPrice: 2 })
        ...
        await this.token.approve(oneHundred, BN(20).mul(DOLLAR), { from: anotherAccount, gasPrice: 2 })
        ...
        await this.token.approve(anotherAccount, BN(100).mul(DOLLAR), { from: oneHundred, gasPrice: 2 })
        ...
        await this.token.approve(oneHundred, BN(101).mul(DOLLAR), { from: anotherAccount, gasPrice: 2 })
