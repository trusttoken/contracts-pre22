...
describe('TrueLender2', () => {
  ...
  beforeEach(async () => {
    ...
    await loanFactory.initialize(poolFactory.address, lender.address, AddressZero, AddressZero, mockCreditModel.address, mockCreditOracle.address, borrowingMutex.address, AddressZero)
