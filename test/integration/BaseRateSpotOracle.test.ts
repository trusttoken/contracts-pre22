...
import { BaseRateSpotOracle, BaseRateSpotOracle__factory } from 'contracts'
import { expect, use } from 'chai'
import { solidity } from 'ethereum-waffle'

use(solidity)

describe.only('BaseRateSpotOracle', () => {
  ...
  beforeEach(async () => {
    oracle = await new BaseRateSpotOracle__factory(owner).deploy(USDC_ADDRESS, AAVE_LENDING_POOL, 1)
  })
