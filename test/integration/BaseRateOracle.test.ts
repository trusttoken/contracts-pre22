...
import { BaseRateOracle, BaseRateOracle__factory } from 'contracts'
import { expect, use } from 'chai'
import { solidity } from 'ethereum-waffle'

use(solidity)

describe.only('BaseRateOracle', () => {
  ...
  beforeEach(async () => {
    oracle = await new BaseRateOracle__factory(owner).deploy(USDC_ADDRESS, AAVE_LENDING_POOL, 1)
  })
