...
contract.skip('TrueRewardBackedToken', function (accounts) {
  ...
  describe('TrueReward setup', function () {
    ...
    it('enables trueReward with 100 balance', async function () {
      ...
      assert.equal(finOpSupply, 98058252427184470000)
  ...
  describe('TrueReward with Aave', function () {
    ...
    it('enables truereward', async function () {
      ...
      const totalSupply = await this.token.totalSupply.call()
      assert.equal(totalSupply, to18Decimals(400))
      const balance = await this.token.balanceOf.call(holder)
    ...
    it('two accounts enable truereward', async function () {
      ...
      assert.equal(interfaceSharesTokenBalance, to18Decimals(200))
      const finOpSupply = await this.token.finOpSupply.call()
      assert.equal(finOpSupply, to18Decimals(200))
      const totalSupply = await this.token.totalSupply.call()
    ...
    it('balance increases after tokenValue increases', async function () {
      ...
      balance = await this.token.balanceOf.call(holder)
      assert.equal(balance, 106666666666666670000)
    })
    ...
    it('sender truereward enabled recipient not enabled tokenValue = 1', async function () {
      ...
      assert.equal(loanBackedTokenBalance, to18Decimals(50))
      assert.equal(finOpSupply, to18Decimals(50))
      assert.equal(totalSupply, to18Decimals(350))
    ...
    describe('Truereward - tokenValue != 1 ', function () {
      it('sender truereward enabled recipient not enabled', async function () {
        ...
        assert.equal(senderBalance, to18Decimals(50))
        assert.equal(receipientBalance, to18Decimals(50))
        assert.equal(loanBackedTokenBalance, 33333333333333330000) // 50 / 1.5
        assert.equal(finOpSupply, 33333333333333330000)
        assert.equal(totalSupply, to18Decimals(350))
        assert.equal(interfaceSharesTokenBalance, to18Decimals(50))
      })
      ...
      it('sender truereward enabled recipient enabled', async function () {
        ...
        assert.equal(senderBalance, to18Decimals(50))
        assert.equal(receipientBalance, to18Decimals(50))
        assert.equal(senderLoanBackedTokenBalance, 33333333333333330000)
        assert.equal(receipientLoanBackedTokenBalance, 33333333333333330000)
        assert.equal(finOpSupply, 66666666666666660000)
        assert.equal(totalSupply, to18Decimals(400))
        assert.equal(interfaceSharesTokenBalance, to18Decimals(100))
      })
      ...
      it('sender truereward not enabled recipient enabled', async function () {
        ...
        assert.equal(senderBalance, to18Decimals(50))
        assert.equal(receipientBalance, to18Decimals(50))
        assert.equal(senderLoanBackedTokenBalance, 0)
        assert.equal(receipientLoanBackedTokenBalance, 33333333333333330000)
        assert.equal(finOpSupply, 33333333333333330000)
        assert.equal(totalSupply, to18Decimals(350))
        assert.equal(interfaceSharesTokenBalance, to18Decimals(50))
    ...
    describe('Truereward - aave with interest ', function () {
      it('sender truereward enabled recipient not enabled', async function () {
        ...
        const totalSupply = await this.token.totalSupply.call()
        const interfaceSharesTokenBalance = await this.sharesToken.balanceOf.call(this.financialOpportunity.address)
        assert.equal(senderBalance, 56666666666666660000) // (100/1.5)*1.6 - 50
        assert.equal(receipientBalance, to18Decimals(50))
        assert.equal(senderLoanBackedTokenBalance, 35416666666666670000) // 56666666666666660000/1.6
        assert.equal(receipientLoanBackedTokenBalance, 0)
        assert.equal(finOpSupply, 35416666666666670000)
        assert.equal(totalSupply, 356666666666666700000)
        assert.equal(interfaceSharesTokenBalance, 56666666666666660000)
      })
      ...
      it('sender truereward enabled recipient enabled', async function () {
        ...
        const totalSupply = await this.token.totalSupply.call()
        const interfaceSharesTokenBalance = await this.sharesToken.balanceOf.call(this.financialOpportunity.address)
        assert.equal(senderBalance, 56666666666666660000)
        assert.equal(receipientBalance, 50000000000000000000)
        assert.equal(senderLoanBackedTokenBalance, 35416666666666670000)
        assert.equal(receipientLoanBackedTokenBalance, 31250000000000000000)
        assert.equal(finOpSupply, 66666666666666660000)
        assert.equal(totalSupply, 406666666666666700000)
        assert.equal(interfaceSharesTokenBalance, 106666666666666670000)
      })
      ...
      it('sender truereward not enabled recipient enabled', async function () {
        ...
        assert.equal(receipientBalance, to18Decimals(50))
        assert.equal(senderLoanBackedTokenBalance, 0)
        assert.equal(receipientLoanBackedTokenBalance, to18Decimals(31.25)) // 31.25*1.6
        assert.equal(finOpSupply, to18Decimals(31.25))
        assert.equal(totalSupply, to18Decimals(350))
        assert.equal(interfaceSharesTokenBalance, to18Decimals(50))
      })
    })
