  ...
  describe('liquidate', () => {
    ...
    describe('reverts if', () => {
      ...
      it('loans are not created via factory', async () => {
        ...
        await fakeLoan.initialize(usdcPool.address, borrowingMutex.address, borrower.address, borrower.address, AddressZero, owner.address, liquidator.address, AddressZero, parseUSDC(1000), YEAR, 1000)
