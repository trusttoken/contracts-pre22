...
contract TokenController {
    ...
    */
    ...
    /**
     * @dev Sets the contract trueRewards contract in the token
     * Controls access to reserve functions to allow providing liquidity
     */
    function setTrueRewardsAddress(address _trueRewardsAddress) external onlyOwner {
        token.setTrueRewardsAddress(_trueRewardsAddress);
    }
