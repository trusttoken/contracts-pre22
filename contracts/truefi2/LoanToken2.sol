...
contract LoanToken2 is ILoanToken2, ERC20 {
    ...
    uint8 public constant override version = 4;
    ...
    constructor(
        ...
        uint256 _term,
        uint256 _apy
    ) public ERC20("Loan Token V2", "LOAN2") {
    ...
    function fund() external override onlyAwaiting onlyLender {
        ...
        require(token.transferFrom(msg.sender, address(this), receivedAmount()));
    ...
    function withdraw(address _beneficiary) external override onlyBorrower onlyFunded {
        ...
        require(token.transfer(_beneficiary, receivedAmount()));
    ...
    function redeem(uint256 _amount) external override onlyClosed {
        ...
        require(token.transfer(msg.sender, amountToReturn));
    ...
    function reclaim() external override onlyClosed onlyBorrower {
        ...
        require(token.transfer(borrower, balanceRemaining));
